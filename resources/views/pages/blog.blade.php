    ...
    <div class="mt-10 lg:mt-14">
        <div class="grid grid-cols-1 gap-x-6 gap-y-10 md:grid-cols-2">
            ...
            <div class="">
                <div class="relative">
                    <a href="article.html" class="group block aspect-6/4 overflow-hidden rounded-lg">
                        <img src="assets/img/blog-img-4.jpg" alt="" class="h-full w-full rounded-lg object-cover transition duration-700 group-hover:scale-105" />
                    </a>
            ...
            <div class="">
                <div class="relative">
                    <a href="article.html" class="group block aspect-6/4 overflow-hidden rounded-lg">
                        <img src="assets/img/blog-img-5.jpg" alt="" class="h-full w-full rounded-lg object-cover transition duration-700 group-hover:scale-105" />
                    </a>
            ...
            <div class="">
                <div class="relative">
                    <a href="article.html" class="group block aspect-6/4 overflow-hidden rounded-lg">
                        <img src="assets/img/blog-img-6.jpg" alt="" class="h-full w-full rounded-lg object-cover transition duration-700 group-hover:scale-105" />
                    </a>
